...
contract UniswapV3PoolMock is IUniswapV3Pool, NoDelegateCall {
    ...
    function collectProtocol(
        ...
        uint128 amount0Requested,
        uint128 amount1Requested
    ) external override onlyFactoryOwner returns (uint128 amount0, uint128 amount1) {
